...
for alpha in alphas:
    ...
    for epsilon in epsilons:
        ...
        plot_1(avg_overall_actions_before_start[1:], 'n-steps Semi Gradient', 'Cart Pole', 'Time steps', 'Episodes', episodes_per_algo)
        plot_2(avg_overall_actions, std_overall_actions, 'n-steps Semi Gradient', 'Cart Pole', 'Episodes', '#Number of Actions', episodes_per_algo)