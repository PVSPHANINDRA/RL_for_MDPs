...
for alpha in alphas:
    ...
    for sigma in sigmas:
        ...
        plot_1(avg_overall_actions_before_start[1:], 'One Step Actor Critic', 'Acrobot', 'Time steps', 'Episodes', episodes_per_algo)
        plot_2(avg_overall_actions, std_overall_actions, 'One Step Actor Critic', 'Acrobot', 'Episodes', '#Number of Actions', episodes_per_algo)